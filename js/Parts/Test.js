...
export const myHingeLeft = {
    ...
    create(setCollisionMask=true) {
        let posStick = {x: 15, y: 0, z: 95};     // Cube
        let sizeStick = {radius : 2, height : 50, radialSegments : 20, heightSegments : 5, openEnded : false,  thetaStart : 0, thetaLength : 2*Math.PI};   // Størrelse på pinnen.
        ...
        this.stickMesh = new THREE.Mesh(
            new THREE.ConeGeometry(sizeStick.radius, sizeStick.height, sizeStick.radialSegments,
                sizeStick.heightSegments, sizeStick.openEnded, sizeStick.thetaStart, sizeStick.thetaLength),
