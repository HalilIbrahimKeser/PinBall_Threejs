// import * as THREE from "../../lib/three/build/three.module";
//
// let springCubeMesh1 = new THREE.Mesh(new THREE.BoxGeometry(sprConsSettings.size1.x, sprConsSettings.size1.y, sprConsSettings.size1.z), material1);
// springCubeMesh1.position.set(sprConsSettings.pos1.x, sprConsSettings.pos1.y, sprConsSettings.pos1.z);
//
// let springCubeMesh2 = new THREE.Mesh(
//     new THREE.SphereGeometry(sprConsSettings.size2.radius, sprConsSettings.size2.widthSegments, sprConsSettings.size2.heightSegments,
//         sprConsSettings.size2.phiStart, sprConsSettings.size2.phiLength, sprConsSettings.size2.thetaStart, sprConsSettings.size2.thetaLength), material2);
...
//     new Ammo.btVector3( sprConsSettings.size1.x/2, sprConsSettings.size1.y/2, sprConsSettings.size1.z/2 ) );
//
//
//
//
//
//
// {radius: 2, widthSegments: 7, heightSegments: 7, phiStart : 0, phiLength : PI * 2,thetaStart : 0, thetaLength : PI},
//
//
//
//
...
// import {Math} from "../../../PinBall/lib/three/build/three.module.js";
//
// /**
...
//     springConstraintUpperBox: undefined,
//     springConstraintLowerBox: undefined,
//
//     TERRAIN_SIZE: 100,
//
//     init(myPhysicsWorld) {
...
//
//
//         let springConstraintMesh = this.createSpringConstraint( 0,5, {x: 90, y: 15, z: 91}, {x: 90, y: 15, z: 20},
//             {x: 7, y: 7, z: 7}, {x: 7, y: 7, z: 7},
//             springConstraintMaterial1, springConstraintMaterial2);
//         groupMesh.add(springConstraintMesh.springCubeMesh1); //Får 2 stk Mesh i retur. Nummer 1.
//         groupMesh.add(springConstraintMesh.springCubeMesh2); //Nummer 2.
//
//
...
//         // Spring constraint
//         this.addAmmo(springConstraintMesh.springCubeMesh1, this.springConstraintUpperBox, groupMesh, 0.05, 0.3, position, mass, setCollisionMask);
//         this.addAmmo(springConstraintMesh.springCubeMesh2, this.springConstraintLowerBox, groupMesh, 0.05, 0.3, position, mass, setCollisionMask);
//     },
//
...
//         };
//
//         let springCubeMesh1 = new THREE.Mesh(
//             new THREE.BoxGeometry(sprConsSettings.size1.x, sprConsSettings.size1.y, sprConsSettings.size1.z), material1);
//
//         springCubeMesh1.position.set(sprConsSettings.pos1.x, sprConsSettings.pos1.y, sprConsSettings.pos1.z);
//
//         let springCubeMesh2 = new THREE.Mesh(
//             new THREE.BoxGeometry(sprConsSettings.size2.x, sprConsSettings.size2.y, sprConsSettings.size2.z), material2);
//
//         springCubeMesh2.position.set(sprConsSettings.pos2.x, sprConsSettings.pos2.y, sprConsSettings.pos2.z);
//
//         // Ammo: samme shape brukes av begge RBs:
